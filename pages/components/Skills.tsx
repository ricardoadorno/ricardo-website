...
function Skills() {
  return (
    <div>
      <main className="bg-gray-800 container mx-auto px-6 w-screen py-5">
            ...
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                ...
                <div className="text-gray-500">
                  A deep base on web technologies like HTML, CSS and Browser
                  APIs. The fetch API, creating responsive layouts and knowledge
                  of CSS frameworks like Bootstrap and
            ...
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                ...
                <div className="text-gray-500">
                  ...
                  I have experience with React Hooks, State Management
            ...
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                ...
                <div className="text-gray-500">
                  ...
                  Authetentication, REST API's, and Database intergration are
                  some of my skills on regards to Node.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 xl:w-1/3 px-6 py-3">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                ...
                <div className="text-gray-500">
                  The most popular relational database management system. I have
                  a good understanding of SQL and how to use it to create, read,
          ...
          <div className="w-full md:w-1/2 xl:w-1/3 px-6 py-3">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                ...
                <div className="text-gray-500">
                  The most popular design tool for creating user interfaces. As
                  a developter, I find useful to have a good understanding of
                  design tools and design principles.
                </div>
              </div>
            </div>
          </div>
